...
public class MediaController {
    ...
    @PostMapping(value = "/upload", consumes = SpringMediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    public ResponseEntity<List<MediaDto>> getMediaByType(@PathVariable MediaType mediaType) {
